...
datas = [
        ('C:\\dev\\transcoder\\ffmpeg_binaries', 'ffmpeg'),
        ('C:\\dev\\transcoder\\LICENSE', 'LICENSE'),
        ('C:\\dev\\transcoder\\NOTICE.md', 'NOTICE.md'),
        ('C:\\dev\\transcoder\\THIRD_PARTY_LICENSES.md', 'THIRD_PARTY_LICENSES.md')
    ]
